...
use Lines202412\PhpParser\NodeTraverser;
use Lines202412\PhpParser\Parser;
use Lines202412\SebastianBergmann\LinesOfCode\Counter;
use Throwable;
use Lines202412\TomasVotruba\Lines\NodeVisitor\StructureNodeVisitor;
