...
namespace Lines202509\TomasVotruba\Lines\DependencyInjection;

use Lines202509\Illuminate\Container\Container;
use Lines202509\PhpParser\Parser;
use Lines202509\PhpParser\ParserFactory;
...
use Lines202509\TomasVotruba\Lines\Console\Command\MeasureCommand;
use Lines202509\TomasVotruba\Lines\Helpers\PrivatesAccessor;
final class ContainerFactory
{
    ...
    public function create() : Container
    {
        ...
        $container->singleton(Application::class, function (Container $container) : Application {
            ...
            $application->setDefaultCommand('measure', \true);
