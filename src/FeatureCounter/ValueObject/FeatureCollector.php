...
namespace Lines202606\TomasVotruba\Lines\FeatureCounter\ValueObject;

use Lines202606\PhpParser\Modifiers;
use Lines202606\PhpParser\Node;
use Lines202606\PhpParser\Node\Arg;
use Lines202606\PhpParser\Node\AttributeGroup;
use Lines202606\PhpParser\Node\Expr\ArrowFunction;
use Lines202606\PhpParser\Node\Expr\AssignOp\Coalesce;
use Lines202606\PhpParser\Node\Expr\BinaryOp\Spaceship;
use Lines202606\PhpParser\Node\Expr\CallLike;
use Lines202606\PhpParser\Node\Expr\Match_;
use Lines202606\PhpParser\Node\Expr\NullsafeMethodCall;
use Lines202606\PhpParser\Node\Expr\NullsafePropertyFetch;
use Lines202606\PhpParser\Node\Expr\Throw_;
use Lines202606\PhpParser\Node\FunctionLike;
use Lines202606\PhpParser\Node\Identifier;
use Lines202606\PhpParser\Node\IntersectionType;
use Lines202606\PhpParser\Node\NullableType;
use Lines202606\PhpParser\Node\Param;
use Lines202606\PhpParser\Node\PropertyHook;
use Lines202606\PhpParser\Node\Stmt\Class_;
use Lines202606\PhpParser\Node\Stmt\ClassConst;
use Lines202606\PhpParser\Node\Stmt\Declare_;
use Lines202606\PhpParser\Node\Stmt\Enum_;
use Lines202606\PhpParser\Node\Stmt\Expression;
use Lines202606\PhpParser\Node\Stmt\Property;
use Lines202606\PhpParser\Node\UnionType;
use Lines202606\TomasVotruba\Lines\FeatureCounter\Enum\PhpVersion;
final class FeatureCollector
{
    ...
    public function __construct()
    {
        ...
        $this->phpFeatures[] = new PhpFeature(PhpVersion::PHP_70, 'Coalesce ?? operator', function (Node $node) : bool {
            return $node instanceof \Lines202606\PhpParser\Node\Expr\BinaryOp\Coalesce;
        });
