...
namespace Lines202412\TomasVotruba\Lines\NodeVisitor;

use Lines202412\PhpParser\Node;
use Lines202412\PhpParser\Node\Expr\Closure;
use Lines202412\PhpParser\Node\Expr\FuncCall;
use Lines202412\PhpParser\Node\Name;
use Lines202412\PhpParser\Node\Stmt\Class_;
use Lines202412\PhpParser\Node\Stmt\ClassLike;
use Lines202412\PhpParser\Node\Stmt\ClassMethod;
use Lines202412\PhpParser\Node\Stmt\Enum_;
use Lines202412\PhpParser\Node\Stmt\Function_;
use Lines202412\PhpParser\Node\Stmt\Interface_;
use Lines202412\PhpParser\Node\Stmt\Namespace_;
use Lines202412\PhpParser\Node\Stmt\Trait_;
use Lines202412\PhpParser\NodeVisitorAbstract;
