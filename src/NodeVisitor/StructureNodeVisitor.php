...
namespace Lines202605\TomasVotruba\Lines\NodeVisitor;

use Lines202605\PhpParser\Node;
use Lines202605\PhpParser\Node\Expr\Closure;
use Lines202605\PhpParser\Node\Expr\FuncCall;
use Lines202605\PhpParser\Node\Name;
use Lines202605\PhpParser\Node\Stmt\Class_;
use Lines202605\PhpParser\Node\Stmt\ClassLike;
use Lines202605\PhpParser\Node\Stmt\ClassMethod;
use Lines202605\PhpParser\Node\Stmt\Enum_;
use Lines202605\PhpParser\Node\Stmt\Function_;
use Lines202605\PhpParser\Node\Stmt\Interface_;
use Lines202605\PhpParser\Node\Stmt\Namespace_;
use Lines202605\PhpParser\Node\Stmt\Trait_;
use Lines202605\PhpParser\NodeVisitorAbstract;
