...
namespace Lines202402\TomasVotruba\Lines\NodeVisitor;

use Lines202402\PhpParser\Node;
use Lines202402\PhpParser\Node\Expr\Closure;
use Lines202402\PhpParser\Node\Expr\FuncCall;
use Lines202402\PhpParser\Node\Name;
use Lines202402\PhpParser\Node\Stmt\Class_;
use Lines202402\PhpParser\Node\Stmt\ClassLike;
use Lines202402\PhpParser\Node\Stmt\ClassMethod;
use Lines202402\PhpParser\Node\Stmt\Enum_;
use Lines202402\PhpParser\Node\Stmt\Function_;
use Lines202402\PhpParser\Node\Stmt\Interface_;
use Lines202402\PhpParser\Node\Stmt\Namespace_;
use Lines202402\PhpParser\Node\Stmt\Trait_;
use Lines202402\PhpParser\NodeVisitorAbstract;
