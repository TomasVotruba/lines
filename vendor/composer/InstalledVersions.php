 ...
 */
namespace Lines202307\Composer;

use Lines202307\Composer\Autoload\ClassLoader;
use Lines202307\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Lines202307\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
