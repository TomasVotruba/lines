...
namespace Lines202508\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use Lines202508\Illuminate\Container\Attributes\Bind;
use Lines202508\Illuminate\Container\Attributes\Scoped;
use Lines202508\Illuminate\Container\Attributes\Singleton;
use Lines202508\Illuminate\Contracts\Container\BindingResolutionException;
use Lines202508\Illuminate\Contracts\Container\CircularDependencyException;
use Lines202508\Illuminate\Contracts\Container\Container as ContainerContract;
use Lines202508\Illuminate\Contracts\Container\ContextualAttribute;
use Lines202508\Illuminate\Support\Collection;
use LogicException;
...
class Container implements ArrayAccess, ContainerContract
{
    ...
    protected function getScopedTyped(ReflectionClass $reflection) : ?string
    {
        ...
        if (!empty(\method_exists($reflection, 'getAttributes') ? $reflection->getAttributes(Scoped::class) : [])) {
            return 'scoped';
        }
        return null;
    }
