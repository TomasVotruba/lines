...
namespace Lines202308\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use Lines202308\Illuminate\Contracts\Container\BindingResolutionException;
use Lines202308\Illuminate\Contracts\Container\CircularDependencyException;
use Lines202308\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
