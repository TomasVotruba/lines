...
namespace Lines202402\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use Lines202402\Illuminate\Contracts\Container\BindingResolutionException;
use Lines202402\Illuminate\Contracts\Container\CircularDependencyException;
use Lines202402\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
