...
namespace Lines202307\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use Lines202307\Illuminate\Contracts\Container\BindingResolutionException;
use Lines202307\Illuminate\Contracts\Container\CircularDependencyException;
use Lines202307\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
