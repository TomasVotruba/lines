...
namespace Lines202308\PhpParser\Lexer;

use Lines202308\PhpParser\Error;
use Lines202308\PhpParser\ErrorHandler;
use Lines202308\PhpParser\Lexer;
use Lines202308\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Lines202308\PhpParser\Lexer\TokenEmulator\TokenEmulator;
