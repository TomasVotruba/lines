...
namespace Lines202402\PhpParser\Lexer;

use Lines202402\PhpParser\Error;
use Lines202402\PhpParser\ErrorHandler;
use Lines202402\PhpParser\Lexer;
use Lines202402\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Lines202402\PhpParser\Lexer\TokenEmulator\TokenEmulator;
