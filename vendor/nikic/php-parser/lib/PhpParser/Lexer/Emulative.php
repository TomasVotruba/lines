...
namespace Lines202407\PhpParser\Lexer;

use Lines202407\PhpParser\Error;
use Lines202407\PhpParser\ErrorHandler;
use Lines202407\PhpParser\Lexer;
use Lines202407\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Lines202407\PhpParser\Lexer\TokenEmulator\TokenEmulator;
