...
namespace Lines202401\PhpParser\Lexer;

use Lines202401\PhpParser\Error;
use Lines202401\PhpParser\ErrorHandler;
use Lines202401\PhpParser\Lexer;
use Lines202401\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Lines202401\PhpParser\Lexer\TokenEmulator\TokenEmulator;
