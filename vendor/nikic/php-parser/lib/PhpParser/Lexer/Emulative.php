...
namespace Lines202512\PhpParser\Lexer;

use Lines202512\PhpParser\Error;
use Lines202512\PhpParser\ErrorHandler;
use Lines202512\PhpParser\Lexer;
use Lines202512\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Lines202512\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use Lines202512\PhpParser\PhpVersion;
use Lines202512\PhpParser\Token;
