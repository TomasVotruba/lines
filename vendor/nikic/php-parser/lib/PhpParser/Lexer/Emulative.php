...
namespace Lines202509\PhpParser\Lexer;

use Lines202509\PhpParser\Error;
use Lines202509\PhpParser\ErrorHandler;
use Lines202509\PhpParser\Lexer;
use Lines202509\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Lines202509\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use Lines202509\PhpParser\PhpVersion;
use Lines202509\PhpParser\Token;
