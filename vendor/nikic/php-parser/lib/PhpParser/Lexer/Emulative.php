...
namespace Lines202605\PhpParser\Lexer;

use Lines202605\PhpParser\Error;
use Lines202605\PhpParser\ErrorHandler;
use Lines202605\PhpParser\Lexer;
use Lines202605\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Lines202605\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use Lines202605\PhpParser\PhpVersion;
use Lines202605\PhpParser\Token;
