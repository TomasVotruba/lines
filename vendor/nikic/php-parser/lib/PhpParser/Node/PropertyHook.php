...
namespace Lines202605\PhpParser\Node;

use Lines202605\PhpParser\Modifiers;
use Lines202605\PhpParser\Node\Expr\Assign;
use Lines202605\PhpParser\Node\Expr\PropertyFetch;
use Lines202605\PhpParser\Node\Expr\Variable;
use Lines202605\PhpParser\Node\Stmt\Expression;
use Lines202605\PhpParser\Node\Stmt\Return_;
use Lines202605\PhpParser\NodeAbstract;
