...
namespace Lines202606\PhpParser\Node;

use Lines202606\PhpParser\Modifiers;
use Lines202606\PhpParser\Node\Expr\Assign;
use Lines202606\PhpParser\Node\Expr\PropertyFetch;
use Lines202606\PhpParser\Node\Expr\Variable;
use Lines202606\PhpParser\Node\Stmt\Expression;
use Lines202606\PhpParser\Node\Stmt\Return_;
use Lines202606\PhpParser\NodeAbstract;
