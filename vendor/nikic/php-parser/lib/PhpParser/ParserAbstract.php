 ...
 */
use Lines202412\PhpParser\Node\Expr;
use Lines202412\PhpParser\Node\Expr\Cast\Double;
use Lines202412\PhpParser\Node\Name;
use Lines202412\PhpParser\Node\Param;
use Lines202412\PhpParser\Node\Scalar\Encapsed;
use Lines202412\PhpParser\Node\Scalar\LNumber;
use Lines202412\PhpParser\Node\Scalar\String_;
use Lines202412\PhpParser\Node\Stmt\Class_;
use Lines202412\PhpParser\Node\Stmt\ClassConst;
use Lines202412\PhpParser\Node\Stmt\ClassMethod;
use Lines202412\PhpParser\Node\Stmt\Else_;
use Lines202412\PhpParser\Node\Stmt\ElseIf_;
use Lines202412\PhpParser\Node\Stmt\Enum_;
use Lines202412\PhpParser\Node\Stmt\Interface_;
use Lines202412\PhpParser\Node\Stmt\Namespace_;
use Lines202412\PhpParser\Node\Stmt\Nop;
use Lines202412\PhpParser\Node\Stmt\Property;
use Lines202412\PhpParser\Node\Stmt\TryCatch;
use Lines202412\PhpParser\Node\Stmt\UseUse;
use Lines202412\PhpParser\Node\VarLikeIdentifier;
