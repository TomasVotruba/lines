...
namespace Lines202401\PhpParser;

/*
 * This parser is based on a skeleton written by Moriyoshi Koizumi, which in
 * turn is based on work by Masato Bito.
 */
use Lines202401\PhpParser\Node\Expr;
use Lines202401\PhpParser\Node\Expr\Cast\Double;
use Lines202401\PhpParser\Node\Name;
use Lines202401\PhpParser\Node\Param;
use Lines202401\PhpParser\Node\Scalar\Encapsed;
use Lines202401\PhpParser\Node\Scalar\LNumber;
use Lines202401\PhpParser\Node\Scalar\String_;
use Lines202401\PhpParser\Node\Stmt\Class_;
use Lines202401\PhpParser\Node\Stmt\ClassConst;
use Lines202401\PhpParser\Node\Stmt\ClassMethod;
use Lines202401\PhpParser\Node\Stmt\Else_;
use Lines202401\PhpParser\Node\Stmt\ElseIf_;
use Lines202401\PhpParser\Node\Stmt\Enum_;
use Lines202401\PhpParser\Node\Stmt\Interface_;
use Lines202401\PhpParser\Node\Stmt\Namespace_;
use Lines202401\PhpParser\Node\Stmt\Nop;
use Lines202401\PhpParser\Node\Stmt\Property;
use Lines202401\PhpParser\Node\Stmt\TryCatch;
use Lines202401\PhpParser\Node\Stmt\UseUse;
use Lines202401\PhpParser\Node\VarLikeIdentifier;
