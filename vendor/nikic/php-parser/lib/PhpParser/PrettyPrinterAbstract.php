...
use Lines202606\PhpParser\Internal\DiffElem;
use Lines202606\PhpParser\Internal\Differ;
use Lines202606\PhpParser\Internal\PrintableNewAnonClassNode;
use Lines202606\PhpParser\Internal\TokenStream;
use Lines202606\PhpParser\Node\AttributeGroup;
use Lines202606\PhpParser\Node\Expr;
use Lines202606\PhpParser\Node\Expr\AssignOp;
use Lines202606\PhpParser\Node\Expr\BinaryOp;
use Lines202606\PhpParser\Node\Expr\Cast;
use Lines202606\PhpParser\Node\IntersectionType;
use Lines202606\PhpParser\Node\MatchArm;
use Lines202606\PhpParser\Node\Param;
use Lines202606\PhpParser\Node\PropertyHook;
use Lines202606\PhpParser\Node\Scalar;
