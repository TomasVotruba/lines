...
use Lines202605\PhpParser\Internal\DiffElem;
use Lines202605\PhpParser\Internal\Differ;
use Lines202605\PhpParser\Internal\PrintableNewAnonClassNode;
use Lines202605\PhpParser\Internal\TokenStream;
use Lines202605\PhpParser\Node\AttributeGroup;
use Lines202605\PhpParser\Node\Expr;
use Lines202605\PhpParser\Node\Expr\AssignOp;
use Lines202605\PhpParser\Node\Expr\BinaryOp;
use Lines202605\PhpParser\Node\Expr\Cast;
use Lines202605\PhpParser\Node\IntersectionType;
use Lines202605\PhpParser\Node\MatchArm;
use Lines202605\PhpParser\Node\Param;
use Lines202605\PhpParser\Node\PropertyHook;
use Lines202605\PhpParser\Node\Scalar;
