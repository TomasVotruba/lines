...
use Lines202509\PhpParser\Internal\DiffElem;
use Lines202509\PhpParser\Internal\Differ;
use Lines202509\PhpParser\Internal\PrintableNewAnonClassNode;
use Lines202509\PhpParser\Internal\TokenStream;
use Lines202509\PhpParser\Node\AttributeGroup;
use Lines202509\PhpParser\Node\Expr;
use Lines202509\PhpParser\Node\Expr\AssignOp;
use Lines202509\PhpParser\Node\Expr\BinaryOp;
use Lines202509\PhpParser\Node\Expr\Cast;
use Lines202509\PhpParser\Node\IntersectionType;
use Lines202509\PhpParser\Node\MatchArm;
use Lines202509\PhpParser\Node\Param;
use Lines202509\PhpParser\Node\PropertyHook;
use Lines202509\PhpParser\Node\Scalar;
use Lines202509\PhpParser\Node\Stmt;
use Lines202509\PhpParser\Node\UnionType;
