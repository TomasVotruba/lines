...
namespace Lines202407\Termwind\Actions;

use Lines202407\Termwind\Exceptions\StyleNotFound;
use Lines202407\Termwind\Repositories\Styles as StyleRepository;
use Lines202407\Termwind\Terminal;
...
final class StyleToMethod
{
     ...
     */
    public function __construct(Styles $styles, string $style)
    {
        $this->styles = $styles;
        $this->style = $style;
        // ..
    ...
    public function __invoke(...$arguments) : Styles
    {
        ...
        $method = \array_filter((array) \preg_split('/(?![^\\[]*\\])-/', $method), function ($item) {
            return $item !== \false;
        });
