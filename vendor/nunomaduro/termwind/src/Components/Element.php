...
use Lines202509\Termwind\Html\InheritStyles;
...
abstract class Element
{
     ...
     */
    public final function __construct(OutputInterface $output, $content, ?\Lines202509\Termwind\ValueObjects\Styles $styles = null)
    {
        $this->output = $output;
