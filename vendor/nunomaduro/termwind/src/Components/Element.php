...
abstract class Element
{
     ...
     */
    public final function __construct(OutputInterface $output, $content, ?\Lines202512\Termwind\ValueObjects\Styles $styles = null)
    {
        $this->output = $output;
