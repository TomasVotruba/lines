...
abstract class Element
{
     ...
     */
    public final function __construct(OutputInterface $output, $content, ?Styles $styles = null)
    {
        $this->output = $output;
