...
abstract class Element
{
     ...
     */
    public final function __construct(OutputInterface $output, $content, ?\Lines202401\Termwind\ValueObjects\Styles $styles = null)
    {
        $this->output = $output;
