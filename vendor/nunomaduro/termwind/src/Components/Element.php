...
use Lines202412\Termwind\Html\InheritStyles;
...
abstract class Element
{
     ...
     */
    public final function __construct(OutputInterface $output, $content, ?\Lines202412\Termwind\ValueObjects\Styles $styles = null)
    {
        $this->output = $output;
