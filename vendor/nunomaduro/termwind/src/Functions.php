...
if (!\function_exists('Lines202412\\Termwind\\renderUsing')) {
    /**
...
if (!\function_exists('Lines202412\\Termwind\\style')) {
    /**
     * Creates a new style.
     *
...
if (!\function_exists('Lines202412\\Termwind\\render')) {
    /**
...
if (!\function_exists('Lines202412\\Termwind\\terminal')) {
    /**
...
if (!\function_exists('Lines202412\\Termwind\\ask')) {
    /**
