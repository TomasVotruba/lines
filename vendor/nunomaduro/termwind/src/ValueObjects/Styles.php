...
namespace Lines202606\Termwind\ValueObjects;

use Closure;
use Lines202606\Termwind\Actions\StyleToMethod;
use Lines202606\Termwind\Components\Element;
use Lines202606\Termwind\Components\Hr;
use Lines202606\Termwind\Components\Li;
use Lines202606\Termwind\Components\Ol;
use Lines202606\Termwind\Components\Ul;
use Lines202606\Termwind\Enums\Color;
use Lines202606\Termwind\Exceptions\ColorNotFound;
use Lines202606\Termwind\Exceptions\InvalidStyle;
use Lines202606\Termwind\Repositories\Styles as StyleRepository;
use function Lines202606\Termwind\terminal;
/**
 * @internal
 */
final class Styles
{
    ...
    public final function contentRepeat(string $string) : self
    {
        ...
        $this->textModifiers[__METHOD__] = static function () use($string) : string {
            return \str_repeat($string, (int) \floor(terminal()->width() / \mb_strwidth($string, 'UTF-8')));
        };
    ...
    {
        return \mb_strwidth(\preg_replace(self::STYLING_REGEX, '', $text ?? (($nullsafeVariable1 = $this->element) ? $nullsafeVariable1->toString() : null) ?? '') ?? '', 'UTF-8');
    }
    /**
