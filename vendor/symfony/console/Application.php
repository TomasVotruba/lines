...
use Lines202606\Symfony\Component\Console\Command\CompleteCommand;
use Lines202606\Symfony\Component\Console\Command\DumpCompletionCommand;
use Lines202606\Symfony\Component\Console\Command\HelpCommand;
use Lines202606\Symfony\Component\Console\Command\LazyCommand;
use Lines202606\Symfony\Component\Console\Command\ListCommand;
use Lines202606\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
...
use Lines202606\Symfony\Component\Console\Event\ConsoleAlarmEvent;
...
use Lines202606\Symfony\Component\Console\Exception\CommandNotFoundException;
...
use Lines202606\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use Lines202606\Symfony\Component\Console\Helper\DebugFormatterHelper;
use Lines202606\Symfony\Component\Console\Helper\DescriptorHelper;
use Lines202606\Symfony\Component\Console\Helper\FormatterHelper;
use Lines202606\Symfony\Component\Console\Helper\Helper;
use Lines202606\Symfony\Component\Console\Helper\HelperSet;
use Lines202606\Symfony\Component\Console\Helper\ProcessHelper;
use Lines202606\Symfony\Component\Console\Helper\QuestionHelper;
use Lines202606\Symfony\Component\Console\Input\ArgvInput;
...
use Lines202606\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use Lines202606\Symfony\Component\Console\Style\SymfonyStyle;
use Lines202606\Symfony\Component\DependencyInjection\ContainerInterface as SymfonyContainerInterface;
use Lines202606\Symfony\Component\ErrorHandler\ErrorHandler;
use Lines202606\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use Lines202606\Symfony\Contracts\Service\ResetInterface;
/**
...
class Application implements ResetInterface
{
    ...
    public function __construct(string $name = 'UNKNOWN', string $version = 'UNKNOWN', ?ContainerInterface $container = null)
    {
        $this->name = $name;
    ...
    {
        if (($nullsafeVariable1 = $this->container) ? $nullsafeVariable1->has('services_resetter') : null) {
    ...
    {
        $this->init();
        return isset($this->commands[$name]) || (($nullsafeVariable2 = $this->commandLoader) ? $nullsafeVariable2->has($name) : null) && $this->addCommand($this->commandLoader->get($name));
    }
    /**
    ...
    private function registerContainerServices() : void
    {
        ...
        switch (\true) {
            case !$this->container instanceof SymfonyContainerInterface:
                $lazyCommandIds = $this->container->has('console.lazy_command.ids') ? $this->container->get('console.lazy_command.ids') : [];
                break;
            case $this->container->hasParameter('console.lazy_command.ids'):
                $lazyCommandIds = $this->container->getParameter('console.lazy_command.ids');
                break;
            default:
                $lazyCommandIds = [];
                break;
