...
final class ProgressBar
{
     ...
     * @var int|null
     */
    private $oscProgressState;
    /**
     * @var int|null
     */
    private $oscProgressPercent;
    /**
     * @var mixed[]
     */
    ...
    public function start(?int $max = null, int $startAt = 0) : void
    {
        ...
        if ($this->output->isDecorated()) {
            self::$activeInstances = self::$activeInstances ?? new \WeakMap();
            self::$activeInstances[$this] = \true;
        }
        $this->display();
    }
    /**
    ...
    private function writeOscProgress() : void
    {
        ...
        $this->writeOscRaw(\sprintf("\x1b]9;4;%d;%d\x1b\\", $state, $percent));
    }
    private function writeOscProgressReset() : void
    {
        ...
        if ($this->output->isDecorated()) {
            $this->writeOscRaw("\x1b]9;4;0;0\x1b\\");
        }
    }
