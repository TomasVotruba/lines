...
use Lines202606\Symfony\Component\Console\Formatter\OutputFormatterStyle;
use Lines202606\Symfony\Component\Console\Input\InputInterface;
use Lines202606\Symfony\Component\Console\Input\StreamableInputInterface;
...
use Lines202606\Symfony\Component\Validator\Validation;
use Lines202606\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use function Lines202606\Symfony\Component\String\s;
/**
...
class QuestionHelper extends Helper
{
    ...
    private function mostRecentlyEnteredValue(string $entered) : string
    {
        ...
        $lastChoice = \trim((string) \substr($entered, $lastCommaPos + 1));
     ...
     * @param mixed $value
     */
    private function validateConstraints($value, array $constraints) : void
    {
        if ($this->dispatcher) {
