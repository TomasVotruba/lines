...
use Lines202605\Symfony\Polyfill\Intl\Grapheme as p;
if (!\function_exists('grapheme_stripos')) {
    /**
     * @return int|false
     */
    function grapheme_stripos(?string $haystack, ?string $needle, ?int $offset = 0, ?string $locale = '')
    {
...
if (!\function_exists('grapheme_stristr')) {
     ...
     * @return string|false
     */
    function grapheme_stristr(?string $haystack, ?string $needle, ?bool $beforeNeedle = \false, ?string $locale = '')
    {
...
if (!\function_exists('grapheme_strpos')) {
     ...
     * @return int|false
     */
    function grapheme_strpos(?string $haystack, ?string $needle, ?int $offset = 0, ?string $locale = '')
    {
...
if (!\function_exists('grapheme_strripos')) {
     ...
     * @return int|false
     */
    function grapheme_strripos(?string $haystack, ?string $needle, ?int $offset = 0, ?string $locale = '')
    {
...
if (!\function_exists('grapheme_strrpos')) {
     ...
     * @return int|false
     */
    function grapheme_strrpos(?string $haystack, ?string $needle, ?int $offset = 0, ?string $locale = '')
    {
...
if (!\function_exists('grapheme_strstr')) {
     ...
     * @return string|false
     */
    function grapheme_strstr(?string $haystack, ?string $needle, ?bool $beforeNeedle = \false, ?string $locale = '')
    {
...
if (!\function_exists('grapheme_substr')) {
     ...
     * @return string|false
     */
    function grapheme_substr(?string $string, ?int $offset, ?int $length = null, ?string $locale = '')
    {
