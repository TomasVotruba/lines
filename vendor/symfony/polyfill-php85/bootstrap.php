 ...
 */
use Lines202606\Symfony\Polyfill\Php85 as p;
if (\PHP_VERSION_ID >= 80500) {
    return;
}
if (!\function_exists('Lines202606\\get_error_handler')) {
    function get_error_handler() : ?callable
    {
        return p\Php85::get_error_handler();
    }
}
if (!\function_exists('Lines202606\\get_exception_handler')) {
    function get_exception_handler() : ?callable
    {
        return p\Php85::get_exception_handler();
    }
}
if (!\function_exists('Lines202606\\array_first')) {
    function array_first(array $array)
    {
        return p\Php85::array_first($array);
    }
}
if (!\function_exists('Lines202606\\array_last')) {
    function array_last(array $array)
    {
        return p\Php85::array_last($array);
    }
}
if (\extension_loaded('intl') && !\function_exists('Lines202606\\locale_is_right_to_left')) {
...
if (\extension_loaded('intl') && !\function_exists('Lines202606\\grapheme_levenshtein')) {
