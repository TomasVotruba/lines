 ...
 */
namespace Lines202606\Symfony\Contracts\Service;

use Lines202606\Psr\Container\ContainerInterface;
use Lines202606\Symfony\Contracts\Service\Attribute\Required;
use Lines202606\Symfony\Contracts\Service\Attribute\SubscribedService;
/**
    ...
    public static function getSubscribedServices() : array
    {
        ...
        foreach ($reflectors as $reflector) {
            ...
            if ($reflector instanceof \ReflectionMethod) {
                ...
                if (\PHP_VERSION_ID < 80400 || !$reflector->hasHook(\Lines202606\PropertyHookType::Get)) {
