...
use Lines202605\Symfony\Contracts\Service\Attribute\Required;
use Lines202605\Symfony\Contracts\Service\Attribute\SubscribedService;
/**
    ...
    public static function getSubscribedServices() : array
    {
        ...
        foreach ($reflectors as $reflector) {
            ...
            if ($reflector instanceof \ReflectionMethod) {
                ...
                if (\PHP_VERSION_ID < 80400 || !$reflector->hasHook(\Lines202605\PropertyHookType::Get)) {
